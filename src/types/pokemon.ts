...
export interface PurpleEffectEntry {
  effect: string;
...
export interface ContestEffectEffectEntry {
  effect: string;
  language: NamedAPIResource;
}
...
export interface ChainEvolvesTo {
...
export interface PurpleEvolutionDetail {
...
export interface EvolvesToEvolvesTo {
...
export interface FluffyEvolutionDetail {
  /** The id of the gender of the evolving Pokémon species must be in order to evolve into this Pokémon species. */
  gender: number | null;
  /** The item the evolving Pokémon species must be holding during the evolution trigger event to evolve into this Pokémon species. */
  held_item: null | NamedAPIResource;
...
export interface HeldByPokemonVersionDetail {
  rarity: number;
...
export interface ItemFlingEffectEffectEntry {
  effect: string;
  language: NamedAPIResource;
}
...
export interface PurpleEncounterDetail {
  chance: number;
...
export interface FluffyEffectEntry {
  effect: string;
  language: NamedAPIResource;
}
...
export interface PastValueEffectEntry {
  effect: string;
  language: NamedAPIResource;
  short_effect: string;
}
...
export interface MoveAilmentName {
  language: NamedAPIResource;
  name: string;
}
...
export interface MoveCategoryDescription {
  description: string;
  language: NamedAPIResource;
}
...
export interface PalParkAreaPokemonEncounter {
  base_score: number;
  pokemon_species: NamedAPIResource;
  rate: number;
}
...
export interface AffectingNaturesDecrease {
  max_change: number;
  nature: NamedAPIResource;
}

export interface AffectingNaturesIncrease {
  max_change: number;
  nature: NamedAPIResource;
}
...
export interface PokemonEncounterVersionDetailObject {
  encounter_details: FluffyEncounterDetail[];
  max_chance: number;
  version: NamedAPIResource;
}

export interface FluffyEncounterDetail {
  chance: number;
  condition_values: NamedAPIResource[];
  max_level: number;
  method: NamedAPIResource;
...
export interface PokemonSpecies {
  ...
  evolution_chain: null | APIResource;
...
export interface AffectingMovesDecrease {
  change: number;
  move: NamedAPIResource;
}

export interface AffectingMovesIncrease {
  change: number;
  move: NamedAPIResource;
}
...
export interface SuperContestEffectFlavorTextEntry {
  flavor_text: string;
  language: NamedAPIResource;
}
...
export interface PastDamageRelationDamageRelations {
  double_damage_from: NamedAPIResource[];
  double_damage_to: NamedAPIResource[];
  half_damage_from: NamedAPIResource[];
  half_damage_to: NamedAPIResource[];
...
export interface ListEndpointOptions {
